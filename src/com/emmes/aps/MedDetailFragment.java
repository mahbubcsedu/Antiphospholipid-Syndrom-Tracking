...
import com.emmes.aps.dummy.DummyContent;
...
public class MedDetailFragment extends Fragment {
	...
	private static final String TAG = "MedDetailFragment";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (mItem != null) {
			((TextView) rootView.findViewById(R.id.med_detail)).setText(mItem.id + "\n" + mItem.content + "\n" + mItem.content);
		}
